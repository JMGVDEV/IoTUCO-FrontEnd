    ...
    render() {
        ...
        return (
            ...
            <div className="container"  >
                ...
                <Grid container justify="center">
                    <Box my={3}>
                        <Typography align='center' variant="h3" style={{ color: 'darkblue' }} gutterBottom>
                        Cama {this.props.location.bed},Invernadero 1
                    </Typography>
                    <Typography align='center' variant="h5" style={{ color: 'black' }} gutterBottom>
                            Peste: 
                    </Typography>
                    <Typography align='center' variant="h5" style={{ color: 'red' }} gutterBottom>
                            {this.state.desease}
                    </Typography>
                    </Box>
                ...
                <Grid container justify="center">
                    <Box component="div" display="inline" p={5} m={1} bgcolor="background.paper">
                        <Typography align='center' variant="h6" style={{ color: 'black' }} gutterBottom>
                            humedad:  {this.props.location.hum}%
                        </Typography>
                    </Box>{'   '}

                    <Box component="div" display="inline" p={5} m={1} bgcolor="background.paper">
                        <Typography align='center' variant="h6" style={{ color: 'black' }} gutterBottom>
                            temperatura: {this.props.location.temp}°c
                        </Typography>
                    </Box>
                </Grid>

                <Grid container justify="center" item >
                    <DropdownButton id="dropdown-basic-button" title="DISEASES" onChange={this.selectOption}>
                        {this.state.disease && (this.state.disease.map(sick =>
                        <DropdownItem onClick={(e) => { this.getIdDisaeses(null,sick) }} key={sick}>{sick}</DropdownItem>))}
                    </DropdownButton>
                </Grid>
                ...
                <div style={{ padding: 30 }}>
                    <Grid container justify="center"  >
                        <Button onClick={this.Send} variant="contained" color="primary" className='configure'>
                            SEND
                    </Button>
                    </Grid>
                </div>
